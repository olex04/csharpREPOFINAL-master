...
{
    public partial class GestaoDeAluguer : Form
    {

        private BaseDeDadosContainer database = new BaseDeDadosContainer();

        public GestaoDeAluguer()
        {
            InitializeComponent();
        ...
        {
            AtualizarCarrosEmUso();
            AddCarroAluguer addCarro = new AddCarroAluguer();
        ...
        private void buttonEditarCarroAluguer_Click(object sender, EventArgs e)
        {
            ...
            if (listBoxCarrosAluguer.SelectedIndex == -1)
                return;
            EditarCarroAluguer editarCarroAluguer = new EditarCarroAluguer(carroAluguerSelecionado);
        ...
        private void buttonVerAluguerAoPormenor_Click(object sender, EventArgs e)
        {
            ...
            if (listBoxAlugueresDoCliente.SelectedIndex == -1)
                return;
            ExaminarAluguer examinarAluguer = new ExaminarAluguer(aluguerSelecionado);
        ...
        private void buttonExaminarCarro_Click(object sender, EventArgs e)
        {
            ...
            if (listBoxCarrosAluguer.SelectedIndex == -1)
                return;
            ExaminarCarroAluguer examinarCarroAluguer = new ExaminarCarroAluguer(carroAluguerSelecionado);
