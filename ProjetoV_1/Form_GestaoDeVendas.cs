...
{
    public partial class Form_GestaoDeVendas : Form
    {
        BaseDeDadosContainer database = new BaseDeDadosContainer();

        public Form_GestaoDeVendas()
        {
            InitializeComponent();
        ...
        private void buttonEditarVenda_Click(object sender, EventArgs e)
        {
            ...
            Form_EditarVendas editarVendas = new Form_EditarVendas(vendaSelecionada);
        ...
        private void buttonExaminarVenda_Click(object sender, EventArgs e)
        {
            ...
            if (listboxCliente.SelectedIndex == -1)
                return;
            Form_ExaminarVenda examinarVenda = new Form_ExaminarVenda(vendaSelecionada);
