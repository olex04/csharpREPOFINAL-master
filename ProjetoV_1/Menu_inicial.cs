...
namespace ProjetoV_1
{
    public partial class Menu_inicial : Form
    {
        ...
        {
            Painel_dos_menus.Controls.Clear();
            GestaoDeOficina gestaoOficina = new GestaoDeOficina();
        ...
        {
            Painel_dos_menus.Controls.Clear();
            GestaoDeAluguer gestao_alug_form = new GestaoDeAluguer();
        ...
        {
            Painel_dos_menus.Controls.Clear();
            GestaoDeVendas gestao_vend_form = new GestaoDeVendas();
        ...
        {
            GestaoDeAdministradores gestaoDeAdministradores = new GestaoDeAdministradores(AdminLogadoMenu);
            Painel_dos_menus.Controls.Clear();
