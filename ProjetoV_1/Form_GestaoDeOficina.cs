...
{
    public partial class Form_GestaoDeOficina : Form
    {
        private BaseDeDadosContainer database = new BaseDeDadosContainer();


        public Form_GestaoDeOficina()
        {
            InitializeComponent();
        ...
        private void buttonExaminarServico_Click(object sender, EventArgs e)
        {
            ...
            if (listBoxServicos.SelectedIndex == -1)
                return;
            Form_ExaminarServico examinarServico = new Form_ExaminarServico(servicoSelecionado);
